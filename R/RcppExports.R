...
intersect_ellipses <- function(par, circles, n_threads = 1L) {
    .Call(`_eulerr_intersect_ellipses`, par, circles, n_threads)
}

optim_final_loss <- function(par, areas, circles, n_threads = 1L) {
    .Call(`_eulerr_optim_final_loss`, par, areas, circles, n_threads)
}
