...
test_that("expect no errors for a variety of predefined sets", {
  ...
  expect_error(euler(s1, shape = "circle"), NA)
  expect_error(euler(s2, shape = "circle"), NA)
  expect_error(euler(s3, shape = "circle"), NA)
  expect_error(euler(s4, shape = "circle"), NA)
  expect_error(euler(s5, shape = "circle"), NA)
  expect_error(euler(s6, shape = "circle"), NA)
  expect_error(euler(s7, shape = "circle"), NA)
  expect_error(euler(s8, shape = "circle"), NA)
  expect_error(euler(s9, shape = "circle"), NA)
  expect_error(euler(s10, shape = "circle"), NA)
  expect_error(euler(s11, shape = "circle"), NA)
  expect_error(euler(s12, shape = "circle"), NA)
  expect_error(euler(s13, shape = "circle"), NA)
  expect_error(euler(s14, shape = "circle"), NA)
  expect_error(euler(s15, shape = "circle"), NA)
  expect_error(euler(s16, shape = "circle"), NA)
  ...
  expect_error(euler(s15,
                     ...
                     control = list(extraopt_control = list(itermax = 50))),
               NA)
  expect_error(euler(s16, shape = "ellipse"), NA)
})
