...
```{r venneuler_failure, fig.height=5, fight.width=5, fig.cap='venneuler plot with unwanted overlap.'}
...
```{r eulerr_plot, fig.width=4, fig.height=4, fig.show='hold', fig.cap='eulerr plots can be modified in every possible way.'}
par(mar = c(0, 0, 0, 0))
plot(fit2)
