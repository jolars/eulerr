...
diagError               `diag_error`   $\max_i \big|y_i/\sum_k y_k - \hat y_i / \sum_k \hat y_k \big|$
...
everything else. The `max_abs` and `max_sq` errors, meanwhile, produce
fits that are much more unpredictable since they only care about the
largest error. Finally, `diag_error` results in a diagram that tries to
include many more intersections.
