...
- `"elbow"` — labels are assigned to a left or right column outside the
  diagram, stacked vertically without overlap and reached by an orthogonal
  three-segment ("elbow") leader. Reminiscent of d3-pie style callouts.
...
#| fig-width: 8
#| fig-height: 3
#| fig-cap: "Three exterior-label placement strategies on the same fit"
...
elbow placement takes `labels$elbow = list(margin = ..., min_gap = ...)`,
where `min_gap` sets the minimum vertical centre-to-centre spacing
between stacked label boxes in a column:
