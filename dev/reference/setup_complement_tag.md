# Setup the complement-count tag, in the same shape as a region tag so it shares one [`makeContent.EulerTags()`](https://jolars.github.io/eulerr/dev/reference/makeContent.EulerTags.md) pass.
